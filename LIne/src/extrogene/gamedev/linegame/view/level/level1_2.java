	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		next.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				dc = new challenge(level1_2.this, null, dots);
		...
		play1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						...
						put(enLine.L4_5, Givedots.setall(4, 5, 2));
				...
				drawview = new LindrawView(level1_2.this, null, dots, Linemap,1);
				...
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						...
						put(enLine.L5_7, Givedots.setall(5, 7, 2));
					}
				};
		...
		play3.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						put(enLine.L1_2, Givedots.setall(1, 2, 2));
						put(enLine.L2_3,Givedots.setall(2, 3, 2));
						put(enLine.L4_5, Givedots.setall(4, 5, 1));
						put(enLine.L5_6,Givedots.setall(5, 6, 1));
						put(enLine.L7_8, Givedots.setall(7, 8, 2));
						put(enLine.L8_9,Givedots.setall(8, 9, 2));
						put(enLine.L3_6, Givedots.setall(3, 6, 2));
						put(enLine.L4_7,Givedots.setall(4, 7, 1));
						put(enLine.L6_9,Givedots.setall(6, 9, 2));
						put(enLine.L1_5, Givedots.setall(1, 5, 1));
		...
		play4.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						put(enLine.L1_4, Givedots.setall(1, 4, 2));
						put(enLine.L2_5,Givedots.setall(2, 5, 1));
						put(enLine.L3_6, Givedots.setall(3, 6, 1));
						put(enLine.L4_7,Givedots.setall(4, 7, 2));
				...
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						...
						put(enLine.L2_3,Givedots.setall(2, 3, 1));
						put(enLine.L4_5, Givedots.setall(4, 5, 2));
						put(enLine.L5_6,Givedots.setall(5, 6, 2));
						put(enLine.L7_8, Givedots.setall(7, 8, 1));
						put(enLine.L8_9,Givedots.setall(8, 9, 1));
						put(enLine.L1_4, Givedots.setall(1, 4, 1));
						put(enLine.L2_5,Givedots.setall(2, 5, 2));
						put(enLine.L3_6, Givedots.setall(3, 6, 1));
						put(enLine.L4_7,Givedots.setall(4, 7, 1));
						put(enLine.L5_8, Givedots.setall(5, 8, 2));
						put(enLine.L6_9,Givedots.setall(6, 9, 1));
						put(enLine.L2_4, Givedots.setall(1, 5, 1));
						put(enLine.L2_6,Givedots.setall(5, 9, 1));
						put(enLine.L4_8,Givedots.setall(3, 5, 1));
						put(enLine.L6_8, Givedots.setall(5, 7, 1));
					}
				};
				...
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						...
						put(enLine.L3_5,Givedots.setall(3, 5, 2));
						put(enLine.L5_7, Givedots.setall(5, 7, 2));
					}
				};
				...
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						...
						put(enLine.L5_8, Givedots.setall(5, 8, 1));
						put(enLine.L6_9,Givedots.setall(6, 9, 1));
						put(enLine.L1_5, Givedots.setall(1, 5, 2));
						put(enLine.L5_9,Givedots.setall(5, 9, 2));
						put(enLine.L3_5,Givedots.setall(3, 5, 1));
						put(enLine.L5_7, Givedots.setall(5, 7, 1));
					}
				};
