...
public class level1_3 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		next.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				dc = new challenge(level1_3.this, null, dots);
				...
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						...
						put(enLine.L5_8, Givedots.setall(5, 8, 3));
				...
				HashMap<enLine, Givedots> Linemap = new HashMap<enLine, Givedots>() {
					{
						put(enLine.L1_2, Givedots.setall(1, 2, 1));
						put(enLine.L8_9,Givedots.setall(8, 9, 1));
						put(enLine.L2_6,Givedots.setall(2, 6, 3));
						put(enLine.L4_8, Givedots.setall(4, 8, 3));
						put(enLine.L2_4, Givedots.setall(2, 4, 3));
						put(enLine.L6_8,Givedots.setall(6, 8, 3));
						put(enLine.L1_8,Givedots.setall(1, 8, 3));
						put(enLine.L2_9,Givedots.setall(2, 9, 3));	
					}
				};
